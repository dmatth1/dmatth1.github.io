...
**quicktok** also beats llama.cpp's tokenizer on the Llama-3 vocab by ~14x. **quicktok**'s encode_batch function runs tokenization in parallel and achieves speeds up to 550 MB/s (24× faster than tiktoken batch) on my M1 macbook.
